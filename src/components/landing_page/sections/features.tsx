...
export const Features = () => {
  return (
  <section className='bg-light-purple py-12 px-4'>
...
<h2 className='text-3xl font-bold .text-purple mb-6'>Features</h2>
    ...
    <div className='grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
      {features.map((feature, index) => (
        ...
        >
          <div className='text-purple text-4xl mb-4 justify-center flex'> <Icon icon={feature.icon} width='1.2em' height='1.2em' />
</div>
